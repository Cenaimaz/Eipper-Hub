...
local RightGroupBox = Tabs.Main:AddRightGroupbox('Chack')
RightGroupBox:AddLabel('Superhuman')
RightGroupBox:AddLabel('Death Step')
RightGroupBox:AddLabel('Sharkman Karate')
RightGroupBox:AddLabel('Electric Claw')
RightGroupBox:AddLabel('God Human')

Superhuman = RightGroupBox:AddLabel("N : Superhuman")
DeathStep = RightGroupBox:AddLabel("N : Death Step")
SharkmanKarate = RightGroupBox:AddLabel("N : Sharkman Karate")
ElectricClaw = RightGroupBox:AddLabel("N : Electric Claw")
DragonTalon = RightGroupBox:AddLabel("N : Dragon Talon")
GodHuman = RightGroupBox:AddLabel("N : God Human")
    ...
    function()
        while task.wait() do
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman", true) == 1 then
                Superhuman:SetText("K : Superhuman")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 1 then
                DeathStep:SetText("K : Death Step")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 1 then
                SharkmanKarate:SetText("K : Sharkman Karate")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw", true) == 1 then
                ElectricClaw:SetText("K : Electric Claw")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon", true) == 1 then
                DragonTalon:SetText("K : Dragon Talon")
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman", true) == 1 then
                GodHuman:SetText("K : God Human")
            end
        end
    end
)
...
local MyButton = LeftGroupBox:AddButton('image Kaitun', function()
                            ...
                            for x,y in pairs(game.ReplicatedStorage:GetChildren()) do
                                if y.Name == "Ice Admiral [Lv. 700] [Boss]" then
                                    if y:FindFirstChild("HumanoidRootPart") then
                                        repeat task.wait()
                                            Tween(y.HumanoidRootPart.CFrame * CFrame.new(0,35,5))
                                        until not getgenv().LevelFarm
                                    end
                                end
                            end
